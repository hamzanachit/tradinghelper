...
class BinanceWebSocketWorker extends Command
{
    protected $signature = 'binance:worker {symbol=HBARUSDT} {interval=1m}';
    ...
    {
        $this->info('Starting Binance WebSocket worker...');
    ...
    protected function processMessage($message)
    {
        try {
            ...
            $this->info("Broadcasted candle: {$candle['c']}");
